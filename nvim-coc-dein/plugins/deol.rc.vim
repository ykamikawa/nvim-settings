...
nnoremap <silent><C-o>f :<C-u>Deol zsh -split=floating<CR>
nnoremap <silent><C-o>h :<C-u>Deol zsh -split=farleft<CR>
nnoremap <silent><C-o>l :<C-u>Deol zsh -split=farright<CR>
tnoremap <ESC>   <C-\><C-n>
